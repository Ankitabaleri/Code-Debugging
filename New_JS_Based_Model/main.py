...
def get_args():
    ...
    parser.add_argument("--run_name", type=str, required=True, help="Run name (used for saving logs)")
    parser.add_argument("--dataset_path", type=str, required=True, help="Path to dataset (jsonl or jsonl.gz)")
    ...
    parser.add_argument("--max_iters", type=int, default=1, help="Maximum number of model iterations to fix bugs")
